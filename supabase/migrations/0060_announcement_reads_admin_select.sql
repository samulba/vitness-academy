...
-- ladeReadCounts() hat fuer Admins/Fuehrungskraefte deshalb nur
-- eigene Reads gezaehlt -- nicht alle.
--
-- Fix: Zusaetzliche SELECT-Policy fuer fuehrungskraft+, damit die
-- Admin-Sicht alle Read-Records zaehlen kann.
-- =============================================================
